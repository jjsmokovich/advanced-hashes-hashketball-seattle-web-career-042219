...
def team_colors(team_name)
  game_hash.each do |team, attribute|
    if team_name == attribute[:team_name]
...
def team_names
  team_list =[]
  team_list << game_hash[:home][:team_name]
  team_list << game_hash[:away][:team_name]
  return team_list
end

def player_numbers(team_name)
  game_hash.each do |team, stats| 
    if stats[:players][:jersey][team_name] 
      return stats[:players][:jersey][team_name] 
    end
  end
end
